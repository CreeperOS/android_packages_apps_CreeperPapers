...
public class WallpaperActivity extends Activity {
    ...
    public final String TAG = "CreeperPapers";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        UrlImageViewHelper.setErrorDrawable(getResources().getDrawable(com.rompacme.cpapers.R.drawable.ic_error));
    ...
    public static class WallpaperPreviewFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            mView = inflater.inflate(com.rompacme.cpapers.R.layout.activity_wallpaper, container, false);

            back = (ImageButton) mView.findViewById(com.rompacme.cpapers.R.id.backButton);
            next = (ImageButton) mView.findViewById(com.rompacme.cpapers.R.id.nextButton);
            pageNum = (TextView) mView.findViewById(com.rompacme.cpapers.R.id.textView1);

            thumbs = new ThumbnailView[THUMBS_TO_SHOW];
            thumbs[0] = (ThumbnailView) mView.findViewById(com.rompacme.cpapers.R.id.imageView1);
            thumbs[1] = (ThumbnailView) mView.findViewById(com.rompacme.cpapers.R.id.imageView2);
            thumbs[2] = (ThumbnailView) mView.findViewById(com.rompacme.cpapers.R.id.imageView3);
            thumbs[3] = (ThumbnailView) mView.findViewById(com.rompacme.cpapers.R.id.imageView4);
        ...
        protected void setThumbs() {
            ...
            for (int i = 0; i < thumbs.length; i++) {
                ...
                UrlImageViewHelper.setUrlDrawable(thumbs[i].getThumbnail(), w.getThumbUrl(),
                        com.rompacme.cpapers.R.drawable.ic_placeholder, new ThumbnailCallBack(w, realIndex));
            }
        ...
        public void next() {
            ...
            pageNum.setText(getResources().getString(com.rompacme.cpapers.R.string.page) + " " + (++currentPage + 1));
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            switch (item.getItemId()) {
                case com.rompacme.cpapers.R.id.jump:
                    jumpTo();
                    return true;
                default:
    ...
    public static String getDlDir(Context c) {
        String configFolder = getResourceString(c, com.rompacme.cpapers.R.string.config_wallpaper_download_loc);
    ...
    public static String getSvDir(Context c) {
        String configFolder = getResourceString(c, com.rompacme.cpapers.R.string.config_wallpaper_sdcard_dl_location);
        if (configFolder != null && !configFolder.isEmpty()) {
            return new File(Environment.getExternalStorageDirectory(), configFolder)
                    .getAbsolutePath() + "/";
        } else {
    ...
    protected String getWallpaperDestinationPath() {
        String configFolder = getResourceString(com.rompacme.cpapers.R.string.config_wallpaper_sdcard_dl_location);
        if (configFolder != null && !configFolder.isEmpty()) {
            return new File(Environment.getExternalStorageDirectory(), configFolder)
                    .getAbsolutePath();
        }
        ...
        protected ArrayList<WallpaperCategory> doInBackground(Void... v) {
            ...
            try {
                ...
                if (USE_LOCAL_MANIFEST) {
                    ...
                    URL url = new URL(getResourceString(com.rompacme.cpapers.R.string.config_wallpaper_manifest_url));
